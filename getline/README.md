...
Project exploring static variables, what they are, and how to use them in the C
programming language -- going into further detail with a reimplemenation of the
getline() function.
